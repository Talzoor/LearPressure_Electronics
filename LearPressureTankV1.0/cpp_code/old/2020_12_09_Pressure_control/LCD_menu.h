const char string_00[] PROGMEM = "scr000,2,R"; // screen 0, 2 lines ahead R for left as well
const char string_01[] PROGMEM = "PROG";
const char string_02[] PROGMEM = "Trig rdy";

const char string_34[] PROGMEM = "scr090,2,R"; // screen 0, 2 lines ahead R for left as well
const char string_35[] PROGMEM = "Runing P";
...
const char string_22[] PROGMEM = "      V1.0      ";
