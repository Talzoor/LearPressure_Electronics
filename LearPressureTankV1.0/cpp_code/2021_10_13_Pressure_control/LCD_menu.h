...
const char string_47[] PROGMEM = "scr098,2";
const char string_48[] PROGMEM = "    SD card    ";
const char string_49[] PROGMEM = "      OK      ";

const char string_50[] PROGMEM = "scr097,2";
const char string_51[] PROGMEM = "    SD card    ";
const char string_52[] PROGMEM = "  !! FAILED !!  ";

const char string_53[] PROGMEM = "scr080,2";
const char string_54[] PROGMEM = "--A.POT OVERIDE--";
const char string_55[] PROGMEM = "p.sensr disabled";
...
const char *const menu_table[] PROGMEM = {string_00, string_01, string_02, string_03, string_04, string_05, string_06, string_061,
                                          ...
                                          string_47, string_48, string_49,
                                          string_50, string_51, string_52,
                                          string_53, string_54, string_55
                                         };

const byte stop_sign[8] =
{
0b00000,
0b00000,
0b10001,
