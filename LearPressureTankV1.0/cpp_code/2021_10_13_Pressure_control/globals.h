...
#define SD_NUMBERING_FILE "NUM_FILE.txt"
...
const float target_offset = 0.001;

// in 5 sec --> 0.1ATM
const unsigned int ms_weight = 3000;
...
const float pressure_range_ok = 0.015;
...
//which sensor are we using? Honeywell_ABP2 / TE_MS5803_01BA / TE_MS5803_14BA ?
#define Honeywell_ABP2 1
#define TE_MS5803_01BA 2
#define TE_MS5803_14BA 3
#define PRESSURE_SENSOR_HARDWARE TE_MS5803_14BA // <------ change accordingly
...
const double pmin = 0.03; // minimum value of pressure range [bar, psi, kPa, etc.]
...
#define LOG_LEVEL_VERBOSE_STR "VERBOSE"
const char* LOG_LEVEL_STR[] = {"", \
                               LOG_LEVEL_FATAL_STR, \
                               LOG_LEVEL_ERROR_STR, \
                               LOG_LEVEL_WARNING_STR, \
                               LOG_LEVEL_INFO_STR, \
                               LOG_LEVEL_NOTICE_STR, \
                               LOG_LEVEL_TRACE_STR, \
                               LOG_LEVEL_VERBOSE_STR
                              };
#define LOGGER_FILE_PREFIX "log"
#define LOGGER_FILE_SUFFIX ".txt"

unsigned int sd_file_no;
bool log_open = false;
char sd_file_name[40];
bool logger_timestamp = true;
unsigned long logger_time_start = 0;
bool write_csv = true;
